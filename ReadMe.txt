...
5. PROFIT.
6. If you rather want to only copy in the shortcut path directly into the .txt file. remove ".lnk" and the "~" symbol from the code in OpenShortcuts.bat. this would let you run the other .bat files directly instead of using shortcuts to them.
